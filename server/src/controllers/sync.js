...
const syncDocuments = async (
  ...
  for (const doc of sourceDocuments) {
    try {
      ...
      const result = await Model.updateOne({ _id: doc._id }, cleanDoc, {
        upsert: true,
      });
...
exports.syncDatabases = async (req, res) => {
  ...
  //   const localRestaurants = await getAllDocuments(
  //     localDb,
  //     "Restaurant",
  //     Restaurant.schema
  //   );
  //   const localMenuItems = await getAllDocuments(
  //     localDb,
  //     "MenuItem",
  //     MenuItem.schema
  //   );
  ...
  //   const remoteRestaurants = await getAllDocuments(
  //     remoteDb,
  //     "Restaurant",
  //     Restaurant.schema
  //   );
  //   const remoteMenuItems = await getAllDocuments(
  //     remoteDb,
  //     "MenuItem",
  //     MenuItem.schema
  //   );
  ...
  //     restaurants: await syncDocuments(
  //       localRestaurants,
  //       remoteDb,
  //       "Restaurant",
  //       Restaurant.schema
  //     ),
  //     menuItems: await syncDocuments(
  //       localMenuItems,
  //       remoteDb,
  //       "MenuItem",
  //       MenuItem.schema
