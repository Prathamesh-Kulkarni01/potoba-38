  ...
  return (
    <div className="flex flex-col h-screen bg-gray-50">
      ...
      <div className="flex-1 overflow-y-auto pb-24">
        ...
        {/* Search Bar */}
        <div className="bg-card px-4 py-3 sticky top-[72px] z-20 shadow-sm container mx-auto"> {/* Adjusted top for header */}
          ...
          {activeTab === 'menu' && (
            <>
              ...
              {menuCategoriesWithCounts.length > 0 && (
                <div className="bg-card py-4 mt-2 sticky top-[180px] z-10 shadow-sm scrollbar-thin " id="menu-section"> {/* Adjusted sticky top */}
